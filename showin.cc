...
LRESULT CALLBACK CrosshairWndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
  ...
  return CallWindowProcA(app_state.dialogProc, hWnd, msg, wParam, lParam);
}
...
static LRESULT CALLBACK DialogFunc(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
  ...
  case WM_SHOWWINDOW:
  {
    ...
    app_state.dialogProc = (WNDPROC)SetWindowLongPtrA(hDlga, GWLP_WNDPROC, (LONG_PTR)CrosshairWndProc);
